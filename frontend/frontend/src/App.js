...
function App() {
  ...
  const sendMessageToContract = async () => {
    await setCar(color, flavor, size);
  };
  ...
  return (
    <div className="App">
      <div className="container">
        <h1>Lawrence Tasty Cakes</h1>
        <h3>
          <i>Order your tasty cakes</i>
        </h3>
        <br />
        <div className="container">
        <input
        ...
        <br /> <br />
        <button onClick={sendMessageToContract} className="button">Place your cake Order</button>
        <button onClick={getMessageToContract} className="button">get your cake Order</button>
      </div>
        <div className="container">
      {cakeDetails === null ? (
